    ...
    <div class="col-xl-6 col-lg-8">
        <div class="card card-modern mt-5">
            <div class="card-header-gradient">
                ...
                <p class="mb-5 text-white-50">Perbarui informasi akun Wali Kelas Anda</p>
            </div>
            
            <div class="card-body p-4 p-md-5 pt-0">
                <form action="<?= base_url('walas/profile/update') ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    ...
                    <div class="text-center mb-4">
                        ...
                        <span class="badge badge-success px-3 py-1 rounded-pill">Wali Kelas</span>
                    </div>
