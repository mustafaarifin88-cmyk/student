...
defined('UPLOAD_PATH_PROFIL')  || define('UPLOAD_PATH_PROFIL', FCPATH . 'uploads/profil/');
defined('UPLOAD_PATH_SEKOLAH') || define('UPLOAD_PATH_SEKOLAH', FCPATH . 'uploads/sekolah/');